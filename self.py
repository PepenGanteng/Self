...
import PEPEN
from PEPEN.lib.curve.ttypes import *
...
kr = PEPEN.LINE()
#kr.login(qr=True)
kr.login(token='EpO34R9D9YhD2nEU9OTa.y8oR0MsJAblb0TnVHZHSwG.kfTBf7Uidg/WE+6ECsZSPnTHL2R/xpuoikneDdfXS7Y=')#chery 
kr.loginResult()

print "Udh Kocak Loginnyaaa :v"
reload(sys)
sys.setdefaultencoding('utf-8')

helpmsg ="""℘℮℘єn вσtѕ
===========================
line://ti/p/~pepenlagiboker
   ~~~~~~ cσmmαnd ~~~~~~
❂➣google (text)
❂➣playstore (text)
❂➣instagram (username)
...
Bots=[mid]
owner=["u63c3abd264a36812c1d2d36f87386c5a",mid]
admin=["u63c3abd264a36812c1d2d36f87386c5a",mid]
baby=["u63c3abd264a36812c1d2d36f87386c5a"]#chery/barby/ranita
...
wait = {
    ...
    'timeline':False,
    'autoAdd':True,
    'message':"""Makasih Dah Add Saya Ya Kakak ^_^""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ By Pepen",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
        ...
        if op.type == 26:
            ...
            if "MENTION" in msg.contentMetadata.keys() != None:
                 if wait['kickMention'] == True:
                     contact = kr.getContact(msg.from_)
                     cName = contact.displayName
                     balas = ["Dont Tag Me!! Im Busy, ",cName + " Ngapain Ngetag?, ",cName + " Nggak Usah Tag-Tag! Kalo Penting Langsung Pc Aja, ", "-_-, ","Pepen lagi off, ", cName + " Kenapa Tag saya?, ","SPAM PC aja, " + cName, "Jangan Suka Tag gua, " + cName, "Kamu siapa, " + cName + "?", "Ada Perlu apa, " + cName + "?","Tag doang tidak perlu., "]
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentType = 13
                msg.contentMetadata = {'mid': "u63c3abd264a36812c1d2d36f87386c5a"}
                kr.sendMessage(msg)
...
#==============================================================================#
				...
				if msg.toType == 2:
					if msg.toType == 2:
						print "ok"
						_name = msg.text.replace(":V","")
						gs = kr.getGroup(msg.to)
						gs = kr.getGroup(msg.to)
						gs = kr.getGroup(msg.to)
						kr.sendText(msg.to,":>")
						kr.sendText(msg.to,":D")
						targets = []
						for g in gs.members:
						...
						if targets == []:
							...
							for target in targets:
								try:
									...
									kr.sendText(msg.to,"Njir")
									kr.sendText(msg.to,":V")
              ...
              if msg.from_ in owner:
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        kr.sendText(msg.to,"Tidak ada undangan :V")
                    else:
                        kr.sendText(msg.to,"Invitan tidak ada :V")
...
#==============================================================================#
                 ...
                 cnt = Message()
                 cnt.text = "Jumlah:\👉n" +str(jml) +  "👈 Members"
                 cnt.to = msg.to
                 kr.sendMessage(cnt)
    ...
    for zx in range(0,20):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          kr.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ ByPepen _Bot😊\n\n☆º°˚˚✰ tɛǟʍ ċʏɮɛʀ-ǟʀʍʏ ɮօt ✰º°˚˚☆（＾ω＾）\nąµţ๏ℓɨЌ€ byKi&Pepen ⭐ 👈 »»» http://line.me/ti/p/~pepenlagiboker «««")
          print "Like"
        except:
          pass
      else:
    ...
    for zx in range(0,20):
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in mid:
                try:
                    kr.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
                    kr.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like By Pepen Ganteng")
                    print "Like"
                except:
                    pass
            else:
